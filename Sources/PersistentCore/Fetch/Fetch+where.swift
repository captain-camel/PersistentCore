...
extension Fetch {
    ...
    public func `where`<PropertyType>(_ keyPath: KeyPath<Object, Property<Object>.Stored<PropertyType>>, equals value: PropertyType) -> Fetch {
    ...
    ///
    /// - Returns: The ``Fetch`` with the added filter.
    public func `where`<PropertyType>(_ keyPath: KeyPath<Object, Property<Object>.Relationship<PropertyType>>, equals value: PropertyType) -> Fetch {
        addPredicate(predicate(
            key: Object.meta[keyPath: keyPath].unwrappedKey,
            operation: .equals,
    ...
    ///
    /// - Returns: The ``Fetch`` with the added filter.
    public func `where`(_ isIncluded: @escaping (Object) -> Bool) -> Fetch {
        addPredicate(NSPredicate { object, _ in
            isIncluded(object as! Object)
        }, combinationType: .and)
        return self
    }
    ...
    ///
    /// - Returns: The ``Fetch`` with the added filter.
    public func `where`<PropertyType>(_ keyPath: KeyPath<Object, Property<Object>.Stored<PropertyType>>, greaterThan value: PropertyType) -> Fetch {
        addPredicate(predicate(
            key: Object.meta[keyPath: keyPath].unwrappedKey,
            operation: .greater,
            value: value.storablePrimitive
    ...
    ///
    /// - Returns: The ``Fetch`` with the added filter.
    public func `where`<PropertyType>(_ keyPath: KeyPath<Object, Property<Object>.Stored<PropertyType>>, greaterThanOrEqualTo value: PropertyType) -> Fetch {
        addPredicate(predicate(
            key: Object.meta[keyPath: keyPath].unwrappedKey,
    ...
    ///
    /// - Returns: The ``Fetch`` with the added filter.
    public func `where`<PropertyType>(_ keyPath: KeyPath<Object, Property<Object>.Stored<PropertyType>>, lessThan value: PropertyType) -> Fetch {
        addPredicate(predicate(
            key: Object.meta[keyPath: keyPath].unwrappedKey,
            operation: .less,
            value: value.storablePrimitive
    ...
    ///
    /// - Returns: The ``Fetch`` with the added filter.
    public func `where`<PropertyType>(_ keyPath: KeyPath<Object, Property<Object>.Stored<PropertyType>>, lessThanOrEqualTo value: PropertyType) -> Fetch {
        addPredicate(predicate(
            key: Object.meta[keyPath: keyPath].unwrappedKey,
            operation: .lessEqual,
            value: value.storablePrimitive
